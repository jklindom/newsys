...
$(function(){
		...
		$('ul.tabs3 li').click(function() {
			...
			$('.tab_content3').eq(_index).stop(false, true).show().siblings().hide();
	...
	$.fn.dataTable = function( oInit )
	{
		...
		function classSettings ()
		{
			...
			this.oLanguage = {
				...
				"sZeroRecords": "未找到符合的資料",
				"sEmptyTable": "No data available in table",
				"sLoadingRecords": "載入中...",
				"sInfo": "顯示 _START_ 到 _END_ 筆在全部 _TOTAL_ 筆資料中",
				"sInfoEmpty": "顯示 0 到 0 筆在全部 0 筆資料中",
				"sInfoFiltered": "(從 _MAX_ 筆中篩選)",
				"sInfoPostFix": "",
				"sSearch": "搜尋:",
				"sUrl": "",
				"oPaginate": {

...
function osa_scholarship_form($sn=""){
  ...
  $formValidator_code=$formValidator->render();
	...
	<td class='col'><input type='text' name='sch_link' size='80' value='{$sch_link}' id='sch_link' ></td></tr>
	...
	<td class='col'><input type='text' name='apply_date' size='20' value='{$apply_date}' id='apply_date' class='validate[required]'  onClick=\"WdatePicker({dateFmt:'yyyy-MM-dd' , startDate:'%y-%M-%d}'})\"></td>
	</tr>
	...
	<td class='col'><input type='text' name='apply_link1' size='80' value='{$apply_link1}' id='apply_link1' ></td></tr>
	...
	<td class='col'><input type='text' name='apply_link2' size='80' value='{$apply_link2}' id='apply_link2' ></td></tr>
	...
	<td class='col'><input type='text' name='apply_link3' size='80' value='{$apply_link3}' id='apply_link3' ></td></tr>
...
function list_osa_scholarship($show_function=1){
	...
	$sql = "select * from ".$xoopsDB->prefix("osa_scholarship")." order by sn DESC ";
  ...
  //if(empty($all_content))return "";
	...
	<tr>
	<th width=''>"._MA_OSASCHOLA_SN."</th>
	<th width='20%'>"._MA_OSASCHOLA_SCH_NAME."</th>
	<th width='10%'>"._MA_OSASCHOLA_SCH_DEPART."</th>
	<th width='20%'>"._MA_OSASCHOLA_SCH_REQUIRE."</th>
	<th width='10%'>"._MA_OSASCHOLA_APPLY_DATE."</th>
	<th width='10%'>"._MA_OSASCHOLA_APPLY_FORM1."</th>
	<th width='10%'>"._MA_OSASCHOLA_APPLY_WAY."</th>
	<th width='10%'>"._MA_OSASCHOLA_POST_DATE."</th>
	$function_title</tr>
	<tbody>
	$all_content
	<tr>
	<td colspan=9 class='bar'>
	<a href='{$_SERVER['PHP_SELF']}?op=osa_scholarship_form'  class='link_button_r'>"._BP_ADD."</a>
	{$bar}</td></tr>
	</tbody>
	</table>";
...
/*-----------秀出結果區--------------*/
//module_admin_footer($main,0);//個別設定list_osa_scholarship,osa_scholarship_form,show_one_osa_scholarship
